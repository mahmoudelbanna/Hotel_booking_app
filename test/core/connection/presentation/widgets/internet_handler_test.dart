...
void main() {
  ...
  const keyAnyChildWidget = ValueKey('Any Child Widget');
  ...
  Widget createWidgetUnderTest(Widget child) {
    return MultiBlocProvider(
      ...
      child: MaterialApp(
        ...
        home: Scaffold(body: InternetStateHandler(child: child)),
      ),
    );
  }
  ...
  group('HotelsPage Tests', () {
    testWidgets('shows HotelsPage when internet is connected', (
      ...
      await tester.pumpWidget(
        createWidgetUnderTest(
          const Text(key: keyAnyChildWidget, 'Any Child Widget'),
        ),
      );
      await tester.pump();
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(find.byKey(keyAnyChildWidget), findsNothing);
        expect(find.byKey(keyLoadingInternetWidget), findsNothing);
      },
    );
    ...
    testWidgets('updates UI when internet state changes', (
      ...
      expect(find.byKey(keyAnyChildWidget), findsOneWidget);
      expect(find.byKey(keyLoadingInternetWidget), findsNothing);
      expect(find.byType(NoConnectionHomeErrorLoading), findsNothing);
